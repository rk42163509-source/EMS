...
const LoginLeftSide = () => {
  return (
    ...
    <div className="relative z-10 flex flex-col items-start justify-center p-12 lg:p-20  w-full">
        ...
        <p className="text-slate-400 text-lg max-w-md leading-relaxed">Streamline your workforce operations track attendance,manage payroll, and employee your team securely.</p>
    </div>
    </div>
  );
};
